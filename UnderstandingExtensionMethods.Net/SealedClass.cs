...
namespace UnderstandingExtensionMethods.Net
{
    ...
    internal static class SealedClassExtensions
    {
        internal static SealedClass CreateInstance(string str)
        {
        ...
        internal static IList<string> GetListeString(this SealedClass obj)
        {
        ...
        internal static ConstructorInfo GetConstructor(this Type type, BindingFlags bindingAttr, Type[] types)
        {
